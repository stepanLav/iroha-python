...
ADMIN_ACCOUNT_ID = 'did_sora_c45fd2db74f7751480e7@sora'
ADMIN_PRIVATE_KEY = 'a78403c5798f43f67b9acf20ea3bc2f5de711127304572523e94a75b04271e7c'
...
def transfer_coin_from_admin_to_userone():
    ...
    tx = iroha.transaction([
        iroha.command('TransferAsset', src_account_id=ADMIN_ACCOUNT_ID,
                      ...
                      asset_id='xor#sora', description='usd#xst', amount='1.00')
    ])
